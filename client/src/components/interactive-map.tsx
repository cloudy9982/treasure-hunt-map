...
const dailyTasks: DailyTasks[] = [
  {
    ...
    tasks: {
      romance: {
        ...
        emoji: "💕",
        description:
          "分享一個過去一年中最喜歡的共同回憶，並說出為什麼這個回憶對你很特別。",
        type: "R",
      },
      fun: {
        title: "回憶拼圖",
        emoji: "🧩",
        description: "一起完成一個小拼圖，邊拼邊聊天分享最近的趣事。",
        type: "F",
      },
      challenge: {
        title: "冥想時光",
        emoji: "🧘",
        description: "一起做 10 分鐘的伸展操或瑜伽，感受彼此的呼吸節奏。",
        type: "C",
      },
    },
  },
  {
    ...
    tasks: {
      romance: {
        title: "情話咖啡",
        emoji: "💌",
        description: "各自沖一杯茶或咖啡，並用三句最甜蜜的話分享今天的亮點。",
        type: "R",
      },
      fun: {
        title: "猜猜遊戲",
        emoji: "🎯",
        description:
          "玩 20 個問題猜物遊戲，從房間選一個東西開始，輸的人要被親一下。",
        type: "F",
      },
      challenge: {
        title: "深度對話",
        emoji: "💭",
        description: "聊聊各自最近學到的一件新事物，分享內心的想法。",
        type: "C",
      },
    },
  },
  {
    ...
    tasks: {
      romance: {
        ...
        emoji: "📚",
        description:
          "各自選一篇有趣的文章或 podcast，摘要給對方聽，並說說為什麼想分享。",
        type: "R",
      },
      fun: {
        title: "文字遊戲",
  ...
  },
  {
    ...
    tasks: {
      romance: {
        title: "愛心料理",
        emoji: "💝",
        description: "一起想三個週末晚餐的點子並挑一個，為愛人準備特別的料理。",
        type: "R",
      },
      fun: {
        title: "料理大賽",
        emoji: "👨‍🍳",
        description: "來場迷你料理PK，看誰能做出更有創意的點心或飲品。",
        type: "F",
      },
      challenge: {
        title: "整理時光",
        emoji: "📦",
        description:
          "一起花 15 分鐘整理一個抽屜或桌面區域，創造更美好的生活空間。",
        type: "C",
      },
    },
  },
  {
    ...
    tasks: {
      romance: {
        ...
        emoji: "💍",
        description:
          "寫下一個自己未來一年想完成的目標，然後向對方承諾會努力實現。",
        type: "R",
      },
      fun: {
        title: "夢想清單",
        emoji: "⭐",
        description: "各自列出三個今年想完成的搞笑或有趣願望並分享。",
        type: "F",
      },
      challenge: {
        title: "實際規劃",
        emoji: "📅",
        description: "一起規劃下週的一個實際活動或任務，做好詳細安排。",
        type: "C",
      },
    },
  },
  // Continue with more days...
  {
    ...
    tasks: {
      romance: {
        ...
        emoji: "🎶",
        description:
          "一起聽一首新歌，分享各自的感受，並說說這首歌讓你想到什麼。",
        type: "R",
      },
      fun: {
        title: "音樂遊戲",
        emoji: "🎤",
        description: "來場卡拉OK或哼歌比賽，看誰先讓對方笑出來。",
        type: "F",
      },
      challenge: {
        title: "音樂冥想",
        emoji: "🧘‍♀️",
        description: "閉上眼睛一起聽 10 分鐘純音樂，感受彼此的存在。",
        type: "C",
      },
    },
  },
  {
    ...
    tasks: {
      romance: {
        title: "愛的問答",
        emoji: "💝",
        description: "輪流問對方一個從來沒問過的問題，誠實回答。",
        type: "R",
      },
      fun: {
        title: "趣味競賽",
        emoji: "🏆",
        description: "玩一個簡單的紙筆遊戲，輸的人要完成一個搞笑任務。",
        type: "F",
      },
      challenge: {
        title: "默契測試",
        emoji: "🤝",
        description: "玩默契遊戲：同時指向房間裡的某個物品，看看你們的默契。",
        type: "C",
      },
    },
  },
  {
    ...
    tasks: {
      romance: {
        title: "浪漫計畫",
        emoji: "💍",
        description: "一起規劃一個特別的約會，可以是未來的小旅行。",
        type: "R",
      },
      fun: {
        title: "瘋狂清單",
        emoji: "📝",
        description: "列出三個搞笑或瘋狂的願望清單並分享。",
        type: "F",
      },
      challenge: {
        title: "實用規劃",
        emoji: "🗓️",
        description: "一起規劃下週的實際活動或任務，做好詳細安排。",
        type: "C",
      },
    },
  },
  {
    ...
    tasks: {
      romance: {
        title: "甜蜜回憶",
        emoji: "💕",
        description: "翻看舊照片，各自說一個最甜蜜的回憶片段。",
        type: "R",
      },
      fun: {
        title: "搞笑照片",
        emoji: "📸",
        description: "找出最搞笑的合照，重現當時的表情和動作。",
        type: "F",
      },
      challenge: {
        title: "回憶分享",
        emoji: "🗣️",
        description: "認真聊聊過去一年的成長和變化。",
        type: "C",
      },
    },
  },
  {
    ...
    tasks: {
      romance: {
        title: "浪漫燭光",
        emoji: "🕯️",
        description: "點一根蠟燭，在燭光下靜靜享受彼此的陪伴。",
        type: "R",
      },
      fun: {
        title: "放鬆遊戲",
        emoji: "😌",
        description: "比賽誰能保持最放鬆的姿勢最久，輸的人按摩獲勝者。",
        type: "F",
      },
      challenge: {
        title: "冥想時光",
        emoji: "🧘",
        description: "一起做 5 分鐘的呼吸冥想或靜坐。",
        type: "C",
      },
    },
  },
  {
    ...
    tasks: {
      romance: {
        title: "愛的課堂",
        emoji: "💌",
        description: "教對方一個你會的技能，並給予鼓勵和讚美。",
        type: "R",
      },
      fun: {
        title: "知識競賽",
        emoji: "🧠",
        description: "互相出題考對方，答錯要接受小懲罰。",
        type: "F",
      },
      challenge: {
        title: "知識分享",
        emoji: "📖",
        description: "各自分享一個最近讀到的有趣知識或事實。",
        type: "C",
      },
    },
  },
  {
    ...
    tasks: {
      romance: {
        title: "愛的感謝",
        emoji: "💖",
        description: "寫一張小紙條，列出三件最感謝對方的事情。",
        type: "R",
      },
      fun: {
        title: "感謝表演",
        emoji: "🎭",
        description: "用誇張的方式表達感謝，越戲劇化越好。",
        type: "F",
      },
      challenge: {
        title: "感謝時刻",
        emoji: "🙏",
        description: "各自說三件今天值得感謝的小事。",
        type: "C",
      },
    },
  },
  {
    ...
    tasks: {
      romance: {
        title: "愛的藝術",
        emoji: "💝",
        description: "為對方畫一幅簡單的畫或寫幾句詩。",
        type: "R",
      },
      fun: {
        title: "搞笑創作",
        emoji: "🤹",
        description: "一起創作搞笑的故事或畫出對方的Q版形象。",
        type: "F",
      },
      challenge: {
        title: "創意時間",
        emoji: "✨",
        description: "一起畫個簡單的塗鴉或做個小手工。",
        type: "C",
      },
    },
  },
  {
    ...
    tasks: {
      romance: {
        title: "愛的按摩",
        emoji: "💆‍♀️",
        description: "給對方做溫柔的肩膀按摩，並說些甜蜜的話。",
        type: "R",
      },
      fun: {
        title: "按摩競賽",
        emoji: "🏅",
        description: "比賽誰的按摩技術更好，由被按摩者評分。",
        type: "F",
      },
      challenge: {
        title: "舒適按摩",
        emoji: "🤗",
        description: "輪流給對方做 5 分鐘的手部或肩膀按摩。",
        type: "C",
      },
    },
  },
  {
    ...
    tasks: {
      romance: {
        title: "愛的願望",
        emoji: "💫",
        description: "向許願池許下關於你們關係的美好願望。",
        type: "R",
      },
      fun: {
        title: "搞怪願望",
        emoji: "🌠",
        description: "各自許一個搞笑或奇怪的願望並分享。",
        type: "F",
      },
      challenge: {
        title: "願望清單",
        emoji: "📝",
        description: "各自列出三個今年想完成的實際目標並分享。",
        type: "C",
      },
    },
  },
  {
    ...
    tasks: {
      romance: {
        title: "愛心料理",
        emoji: "👨‍🍳",
        description: "一起準備一個特別的點心，餵對方吃第一口。",
        type: "R",
      },
      fun: {
        title: "瘋狂實驗",
        emoji: "🥼",
        description: "嘗試做一個奇怪的食物組合，看誰敢吃。",
        type: "F",
      },
      challenge: {
        title: "料理時光",
        emoji: "🍳",
        description: "一起準備一個簡單的點心或飲品。",
        type: "C",
      },
    },
  },
  {
    ...
    tasks: {
      romance: {
        title: "深情凝視",
        emoji: "😍",
        description: "看著對方的眼睛 30 秒，不說話只用眼神表達愛意。",
        type: "R",
      },
      fun: {
        title: "觀察遊戲",
        emoji: "🔍",
        description: "比賽誰能觀察到更多房間裡的細節，輪流分享發現。",
        type: "F",
      },
      challenge: {
        title: "觀察練習",
        emoji: "🧐",
        description: "花 5 分鐘安靜地觀察窗外，然後分享各自看到的細節。",
        type: "C",
      },
    },
  },
  {
    ...
    tasks: {
      romance: {
        title: "溫柔擁抱",
        emoji: "💕",
        description: "給對方一個長長的擁抱，感受彼此的溫暖。",
        type: "R",
      },
      fun: {
        title: "擁抱競賽",
        emoji: "🏆",
        description: "比賽各種創意擁抱姿勢，看誰更有創意。",
        type: "F",
      },
      challenge: {
        title: "溫柔時光",
        emoji: "☁️",
        description: "簡單的擁抱和安靜的陪伴，不需要說話。",
        type: "C",
      },
    },
  },
  {
    ...
    tasks: {
      romance: {
        title: "愛的驚喜",
        emoji: "💝",
        description: "為明天準備一個浪漫的小驚喜或紀念品。",
        type: "R",
      },
      fun: {
        title: "搞笑驚喜",
        emoji: "🎪",
        description: "準備一個搞笑的小道具或表演給對方驚喜。",
        type: "F",
      },
      challenge: {
        title: "準備驚喜",
        emoji: "🎀",
        description: "為明天的最終日準備一個實用的小驚喜或紀念品。",
        type: "C",
      },
    },
  },
  {
    ...
    tasks: {
      romance: {
        title: "愛的宣言",
        emoji: "💍",
        description: "交換手寫的愛情宣言，慶祝我們的第一個週年紀念！",
        type: "R",
      },
      fun: {
        title: "週年慶典",
        emoji: "🎉",
        description: "舉辦小型慶祝派對，用搞笑方式重現過去一年的回憶。",
        type: "F",
      },
      challenge: {
        title: "週年總結",
        emoji: "📋",
        description: "一起總結這一年的成長，並規劃下一年的目標。",
        type: "C",
      },
    },
  },
...
export function InteractiveMap() {
  ...
  const handleNodeClick = (node: MapNode) => {
    if (!isDayUnlocked(node.day)) {
      ...
      setShowMessage(
        `🔒 這個地點還沒開放！請在 ${nodeDate.toLocaleDateString("zh-TW", { month: "long", day: "numeric" })} 再來探索！💫`,
      );
  ...
  const handleTaskSelection = (
    day: number,
    taskType: "romance" | "fun" | "challenge",
  ) => {
    ...
    if (dayTasks) {
      ...
      if (newCompletedDays.length === 20) {
        ...
        }, 2000); // Show anniversary card after 2 seconds
      }
    }
  };
  ...
  return (
    <div className="w-full max-w-6xl mx-auto">
        ...
        {/* {testingMode && (
          <button
            onClick={() => {
              ...
              const allTasks: { [day: number]: "romance" | "fun" | "challenge" } = {};
              allDays.forEach(day => {
                allTasks[day] = "romance";
              });
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-3xl p-8 max-w-md w-full">
            <h3 className="text-2xl font-bold love-purple text-center mb-6">
              Day {showTaskSelector} -{" "}
              {mapNodes.find((n) => n.day === showTaskSelector)?.location}
            </h3>
            ...
            <div className="space-y-4">
              {dailyTasks.find((d) => d.day === showTaskSelector) && (
                <>
                  <button
                    onClick={() =>
                      handleTaskSelection(showTaskSelector, "romance")
                    }
                  ...
                  <button
                    onClick={() =>
                      handleTaskSelection(showTaskSelector, "challenge")
                    }
      ...
      {/* Anniversary Card */}
      <AnniversaryCard
        isOpen={showAnniversaryCard}
        onClose={() => setShowAnniversaryCard(false)}
      />
    </div>
  );
}
